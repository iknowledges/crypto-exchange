...
use anyhow::Ok;
use jsonwebtoken::{Algorithm, DecodingKey, EncodingKey, Header, Validation, encode, get_current_timestamp, decode};
...
impl Default for JwtConfig {
    fn default() -> Self {
        Self { 
            ...
            expiration: Duration::from_secs(24 * 60 * 60 * 60),
...
impl JWT {
    pub fn new(config: JwtConfig) -> Self {
        ...
        Self {
            encode_secret: EncodingKey::from_secret(secret),decode_secret: DecodingKey::from_secret(secret),
    ...
    pub fn encode(&self, principal: Principal) -> anyhow::Result<String> {
        ...
        let claims = Claims {
            ...
            sub: format!("{}:{}", principal.id, principal.email),
